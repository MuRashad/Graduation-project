...
const routes: Routes = [
  ...
  { path: "contactSection",canActivate:[authGuardGuard], component: HomeComponent, title: "Contact" },
  { path: "blogSection",canActivate:[authGuardGuard], component: HomeComponent, title: "blog" },
